...
<head>
    ...
    <title>OceanPals | Register</title>
</head>
<body>
    <section class="bg-gray-50 dark:bg-gray-900 bg-gradient-to-tr from-teal-50 to-blue-200">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-8 h-8 mr-2" src="/assets/oceanpals-logo.png" alt="logo">
                OceanPals    
            </a>
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('authRegister') }}" method="POST">
                        @csrf
                        <div>
