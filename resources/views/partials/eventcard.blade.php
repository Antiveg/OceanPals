{{-- @php
    ...
    $events = Events::all(); // Retrieve all events from the database

    // Check if events are retrieved
    if ($events->isNotEmpty()) { // Check if the collection is not empty
        foreach ($events as $event) {
            // Access properties of each event instance
            echo $event->EventName;
            echo $event->EventDescription;
            echo $event->EventLocation;
            // echo $event->EventImage;
            echo $event->EventPoint;
            // You can access other properties similarly, such as $event->EventLocation, $event->EventPoint, etc.
        }
    } else {
            ...
            <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/events/detail" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Join Event</a>
                    </div>
                </div>
            </div>
    @endforeach
